...
enum class KataInfo(val id: Int, val kataName: String, val japaneseName: String, moves: Int) {
    ...
    TEKKI_SHODAN(6, "Tekki Shodan", "鉄騎初段", 23),
    ...
    TEKKI_SANDAN(13, "Tekki Sandan", "鉄騎三段", 26),
    BASSAI_SHO(14, "Bassai-sho", "披塞小", 27),
    JITTE(15, "Jitte", "十手", 24),
    GANKAKU(16, "Gankaku", "岩鶴", 42),
    KANKU_SHO(17, "Kanku-sho", "観空小", 48),
    NIJUSHIHO(18, "Nijushiho", "二十四步", 24),
    CHINTE(19, "Chinte", "珍手", 32),
    UNSU(20, "Unsu", "雲手", 48),
    SOCHIN(21, "Sochin", "壯鎭", 41),
    GOJUSHIHO_DAI(22, "Gojushiho-dai", "五十四歩大", 67),
